    ...
    >
      ...
      {isSuccess ? (
        <div className="relative ml-auto">
          <Combobox.Input
            className="w-full rounded-md border-2 border-gray-300 bg-slate-50 py-2 pl-3 pr-10 font-medium shadow-sm 
            focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500 dark:bg-slate-900"
