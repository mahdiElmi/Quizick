...
export default function Error({ removeQuestions, isLightning }: ErrorProps) {
  ...
  return (
    <div className="flex h-full justify-center">
      <div className="relative mx-2 my-auto flex h-fit max-w-6xl flex-col justify-center place-self-center rounded-2xl bg-red-100 p-6 dark:bg-red-900/40 md:place-items-center lg:mx-auto">
        <h2 className="mb-4 text-4xl font-black md:text-5xl">
          Something Went wrong :(
        </h2>
        <p className="text-2xl font-medium opacity-90 ">
